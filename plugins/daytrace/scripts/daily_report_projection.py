...
from aggregate_core import DEFAULT_GROUP_WINDOW_MINUTES
from common import emit
from projection_adapters import build_projection_payload


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Build aggregate-compatible daily-report input from the DayTrace store.")

...
5. 提案の組み立て:
 ...
 7. 自動判断 — 固定化アクション（`skill-applifier` の Dispatch Rules に従う）:
...
- Phase 3 (Fixation): `skills/skill-applifier/SKILL.md` — CLAUDE.md Immediate Apply, Skill Scaffold Draft, Hook/Agent Next Step, Decision Writeback
...
Phase 3 Fixation (skill-applifier):

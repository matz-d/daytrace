...
5. 提案の組み立て:
 ...
 7. 自動判断 — 固定化アクション:
    ...
    - `suggested_kind == "skill"`: Skill Scaffold Draft Spec に従い scaffold context を提示する。`done` が確認できた時だけ `--completion-state completed` を使う
...
- Phase 3: `skills/skill-miner/SKILL.md` — Classification Rules, Pre-Classification Contract, Oversized Cluster Guard, Proposal Format, Deep Research Rules, CLAUDE.md Immediate Apply Spec, Skill Scaffold Draft Spec, Triage Rules
